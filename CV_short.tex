...
\begin{document}
	...
	\begin{tabbing}
		...
		%	Birthdate: 09.05.1986 \> 	{Piazza della Liassa, 7}  \\
		%	\textit{Nationality:} Brazilian and Italian  \> {Cabella Ligure (AL)}  \\
		%	
		%
		%	\href{https://github.com/llohann-speranca}{\bf GitHub} 	\> 15060, IT\\ 
		%	 \href{https://scholar.google.com.br/citations?hl=pt-BR&user=6eG8d3kAAAAJ&view_op=list_works&gmla=AJsN-F6-AJnmRvPpAUhB4kL_EeaC-aGUL4lLqPZWGk1VlmYZDLqvTj-Op03oOoVo_6TfUshazfkcEfRJDjk72HabsrYpw7kj08WRkdfO1Xp3lrT_EyR6Irk}{\bf Google Scholar}  	 \> \textit{E-mail:} {lsperanca@gmail.com} \\
		%	 
		%	\href{https://www.linkedin.com/in/llohann-dallagnol-speranca}{\bf Linkedin} 	\>\textit{Cell:} +39 351 651 8710
		
		
		Piazza Liassa 7  \>  \href{mailto:lsperanca@gmail.com}{lsperanca@gmail.com}\\
		Cabella Ligure, 15060, IT \> +39 351 651 8710
	...
	%
	%	\vspace{-0.5em}
	%	The	\href{http://ime.unicamp.br/}{\textbf{State University of Campinas}}' Mathematics  is ranked  higher than well-known premier Universities, such as Rice University and Queen Mary University London.
...
%	\begin{outerlist}
 ...
 \textbf{State University of Campinas } 
 
 {Ph.D. in {Mathematics}}, GPA 4/4
