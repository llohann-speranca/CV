...
\begin{document}
	...
	\begin{tabbing}
		...
		\href{https://linkedin.com/in/llohann}{\bf LinkedIn}
		 \> \href{https://scholar.google.com.br/citations?hl=pt-BR&user=6eG8d3kAAAAJ&view_op=list_works&gmla=AJsN-F6-AJnmRvPpAUhB4kL_EeaC-aGUL4lLqPZWGk1VlmYZDLqvTj-Op03oOoVo_6TfUshazfkcEfRJDjk72HabsrYpw7kj08WRkdfO1Xp3lrT_EyR6Irk}{{\bf Google Scholar}}
	\end{tabbing}
...
\item 		Communicated results across areas and levels of science. Inspired students during classes and outreach lectures. 
	...
	\begin{itemize}
		\item Solved a decades-old conjecture, developing techniques reincorporated in further results.
	\item	Influenced the graduate's KPIs, expediting the entrance process by 80\%.
	\item	Led the University Geometry Group transforming the annual local event into a successful national conference with 5x the public.
	\item	Managed more than five funded projects.
	...
	\begin{outerlist}
	\item   Data Analysis, wrangling and statistics (Pandas, NumPy, SciPy, Statsmodels)
	\item   Prediction, regression, classification and clustering with Machine Learning (Scikit-learn, XGBoost, KNN, SVM, K-Means, ...)
	\item   Advanced methods in Deep Learning (Keras, TensorFlow)
	\item Computer Vision (Transfer Learning, Object detection, Object classification)
	\item  Data pipeline orchestration (Airflow, Pandas, PySpark)
	\item   Data extraction (Web Scrapping, RestAPI)
	\item   Visualizations and Dashboards (Matplotlib, Seaborn, Plotly, Dash, Tableau)
	\item   Big Data and Cloud Computing (AWS, BigQuery)
	\item   Capcity to work with an interdiciplinary team
	\item   Apt to communicate with clients and leverage applications of the data and models at hand, especially due to a strong grasp of Machine Learning and statistical theory
	\item   Independent, proactive, creative problem-solver
	\item   Self learner, hands-on approach. Specialized in putting theory to practice.
	\item   Mature critical thinking
	...
	\vspace{-1em}
	\begin{innerlist}[-]
		\item \textbf{IBM Certification of Professional Data Scientist,} IBM Skills Network
		\item \textbf{TensorFlow Developer,} DeepLearning.AI
		\item \textbf{Introduction to Portfolio Construction and Analysis with Python,} EDHEC Business School
		\item \textbf{Introduction to Financial Engineering and Risk Management,} Columbia University in the City of New York 
	\end{innerlist}
...
%			
%			\item \textbf{IBM Certificate Capstone Project}
%			
%			
%			\begin{innerlist}[-]
%				\item \textbf{Responsabilities:} Web Scrapping; Explorative Data Analysis; Database management in the cloud; production of dashboards, maps and visualizations; development of a predictive Machine Learning model.
%				\item \textbf{Achievements:} 			Web Scrapped and Downloaded SpaceX Data from 4 different sources. Used 6+ libraries for Data Cleaning, Wrangling, Analysis, Maps, and Visualization.
%				Improved the expected accuracy by 16\% extrapolating the proposed Machine Learning techniques.
%				
%				\item  			\textbf{Techniques:} Beautiful Soup, Pandas, Pandas Profiling, SQL, Scikit-learn, Matplotlib, Dash, Folium, Plotly, Web Scrapping, Data Wrangling, Pearson Correlation, Phi-k Correlation, Data Visualization, Dashboards, Regression, Classification, Gradient Boost, Reporting.
%				
%			\end{innerlist}
	...
	\section{Summary of Academic Responsabilities}
	...
	\begin{enumerate}
		...
		\item e Silva, R. J. M., Cavenaghi, L. F., Sperança, L. D., Positive Ricci curvature through Cheeger deformations, accepted for publication in Collectanea Mathematica 
		
				\item Grama, L., Martins, R. M., Patrão, M., Seco, L., Sperança, L. D.
		\href{https://arxiv.org/abs/2004.01511}{Global dynamics of the Ricci flow on flag manifolds with three isotropy summands}, \textit{{arxiv:2004.01511}}, accepted for publication in Monatshefte f\"ur Mathematik.
		
				\item Cavenaghi, L. F., Sperança, L. D. The concept of Cheeger deformations on fiber bundles with compact structure group, accepted for publication in the São Paulo Journal of Mathematical Sciences.
...
%	\vspace{-1em}
	...
	\begin{enumerate}
			...
			\item Sperança, L. D. \href{https://arxiv.org/abs/1703.09577}{Totally Geodesic Riemannian Foliations on Compact Lie Groups}, \textit{{arxiv:1703.09577}}
		...
		\item  Mauro, P., Seco, L., Sperança, L. D., \href{https://arxiv.org/abs/2107.11612}{On the embeddability of the homogeneous Ricci flow and its collapses.} \textit{{arXiv:2107.11612}}, submitted to  Annals of Global Analysis and Applications.
